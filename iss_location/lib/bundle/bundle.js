...
},{"satellite.js":5}],2:[function(require,module,exports){
/*!
 * satellite-js v3.0.1
...
// <script src="lib/bundle/bundle.js"></script> in html

// in app.js
// locationArray = window.TestData;
// locationArray({
//   tle: res,
//   stepMS: 5000,
...
//     if (i === 0) {
//       addLine(currentOrbit[0], currentOrbit[0], "blue", 4);
//     } else {
//       addLine(currentOrbit[i-1], currentOrbit[i], "blue", 4);
//     }
//   }

  // })
},{"tle.js/dist/tlejs.cjs":1}]},{},[18]);
